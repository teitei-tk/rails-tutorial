...
(function() {
  (function(w, $) {
    ...
    MarkdownPreview = (function() {
      function MarkdownPreview(args) {
        this.$textArea = args.$textArea, this.$titleArea = args.$titleArea, this.$preViewTitleArea = args.$preViewTitleArea, this.$preViewArea = args.$preViewArea;
      }

      MarkdownPreview.prototype.previewAsTittle = function() {
        return this._preview(this.$titleArea, this.$preViewTitleArea);
      };

      MarkdownPreview.prototype.previewAsContent = function() {
        return this._preview(this.$textArea, this.$preViewArea);
      };

      MarkdownPreview.prototype._preview = function($input, $preview) {
        var text;
        text = $input.val().trim();
        console.log(text);
        if (text.length <= 0) {
        ...
        return $preview.html(w.markdown.toHTML(text));
      };
    ...
    $(function() {
      ...
      $titleArea.on("keyup", function() {
        return viewer.previewAsTittle();
      });
      $textArea.on("keyup ", function() {
        return viewer.previewAsContent();
      });
    });
